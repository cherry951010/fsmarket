    ...
    <div class="w-nav">
        <div class="t-nav">
        	<div class="nav-categorys j-allCate">
                ...
                <ul class="cate-item j-extendCate <?php if ($this->_var['script_name'] != "index"): ?>dis-n<?php endif; ?>" <?php if ($this->_var['script_name'] != "index"): ?>style="height:auto;"<?php endif; ?>>
...
?>
		    ...
		    <li>
                        <div class="cateone cate<?php echo $this->_foreach['foo']['iteration']; ?>">
                        	<a href="<?php echo $this->_var['cat']['url']; ?>"><?php echo htmlspecialchars($this->_var['cat']['name']); ?><i class="iconfont">&#xe600;</i></a>
