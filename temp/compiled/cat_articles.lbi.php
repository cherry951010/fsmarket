...
?>
    <div class="list_son"<?php if ($this->_foreach['article_item']['iteration'] % 4 == 0): ?> style="margin-right:0;"<?php endif; ?>>
	  ...
	  <img data-original="<?php echo $this->_var['article_item']['pic']; ?>" src="themes/shengxian/images/spacer.gif" alt="<?php echo htmlspecialchars($this->_var['article_item']['title']); ?>" title="<?php echo htmlspecialchars($this->_var['article_item']['title']); ?>" class="loading">
        </a>
      </div>
