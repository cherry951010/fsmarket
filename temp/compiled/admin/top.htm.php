...
#menu-div {
	background: #0D8BC8;
	height: 41px;
	border-bottom:1px solid #0C83BC;
}
  ...
  <div id="submenu-div">
    ...
    <li><a href="privilege.php?act=logout" target="main-frame"><img src="images/topmune_08.png" style="border:none;"/><span><?php echo $this->_var['lang']['signout']; ?></span></a></li>
     <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"/><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>      
      ...
      <li><a href="http://php8.taobao.com" target="_blank"><img src="images/topmune_05.png" style="border:none;"/><span>更新补丁</span></a></li>
    ...
    <div id="send_info" style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;  display:none;">
      ...
      <span id="send_msg"><img src="images/top_loader.gif" width="21" height="21" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" /> <?php echo $this->_var['lang']['email_sending']; ?></span>
    ...
    <?php endif; ?>
    <div id="load-div" style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;"><img src="images/top_loader.gif" width="21" height="21" alt="<?php echo $this->_var['lang']['loading']; ?>" style="vertical-align: middle" /> <?php echo $this->_var['lang']['loading']; ?></div>
  </div>
</div>
<div id="menu-div">
  <ul>
    <li class="fix-spacel">&nbsp;</li>
    <li style="border-left:none;"><a href="index.php?act=main" target="main-frame"><img src="images/index-11_07.png" width="17" height="18" style="border:none;" align="absmiddle"/><span><?php echo $this->_var['lang']['admin_home']; ?></span></a></li>
    
    <li><a href="privilege.php?act=modif" target="main-frame"><img src="images/index-11_41.png" width="17" height="18" align="absmiddle"/><span><?php echo $this->_var['lang']['set_navigator']; ?></span></a></li>
    <li><a href="goods.php?act=list" target="main-frame"><img src="images/index-11_09.png" width="17" height="18" align="absmiddle"/><span>商品管理</span><span class="num"><?php echo $this->_var['goods_sum']; ?></span></a></li>
     <li><a href="order.php?act=list" target="main-frame"><img src="images/dd.png" width="15" height="18" align="absmiddle"/><span>订单管理</span><span class="num"><?php echo $this->_var['order_sum']; ?></span></a></li>
     <li><a href="ads.php?act=list" target="main-frame"><img src="images/index-11_13.png" width="17" height="20" align="absmiddle"/><span>广告管理</span><span class="num"><?php echo $this->_var['ad_sum']; ?></span></a></li>
     <li><a href="comment_manage.php?act=list" target="main-frame"><img src="images/index-11_19.png" width="17" height="18" align="absmiddle"/><span>用户评论</span><span class="num"><?php echo $this->_var['comment_sum']; ?></span></a></li>
