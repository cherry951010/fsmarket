  ...
  <div id="compage">
    <div class="pagenav">
      <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
        ...
        <?php endif; ?> 
        <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_24266100_1541926329');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_24266100_1541926329']):
?> 
        <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?> 
        <span class="currentStep"><?php echo $this->_var['key']; ?></span> 
        <?php else: ?> 
        <a href="<?php echo $this->_var['item_0_24266100_1541926329']; ?>" class="step"><?php echo $this->_var['key']; ?></a> 
        <?php endif; ?> 
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
        ...
        <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_24266100_1541926329');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_24266100_1541926329']):
?>
        <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_24266100_1541926329']; ?>" />
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </form>
    </div>
  </div>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_24366100_1541926329');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_24366100_1541926329']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_24366100_1541926329']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
