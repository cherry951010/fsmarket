...
?>
						...
						<div class="product" id="shijian_<?php echo $this->_var['key']; ?>" <?php if ($this->_foreach['name']['iteration'] % 4 == 0): ?>style="margin-right: 0px;"<?php endif; ?>>
							<div class="pic" id="li_<?php echo $this->_var['pre_spike']['goods_id']; ?>">
								<a href="<?php echo $this->_var['pre_spike']['url']; ?>" target="_blank"> <img title="<?php echo htmlspecialchars($this->_var['pre_spike']['goods_name']); ?>" alt="<?php echo htmlspecialchars($this->_var['pre_spike']['goods_name']); ?>" width=220 height=220 data-original="<?php echo $this->_var['pre_spike']['goods_thumb']; ?>" src="themes/shengxian/images/spacer.gif" class="loading pic_img_<?php echo $this->_var['pre_spike']['goods_id']; ?>"></a> <?php if ($this->_var['pre_spike']['is_best']): ?>
