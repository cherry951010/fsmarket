...
?> 
        ...
        <li <?php if ($this->_foreach['goods']['iteration'] % 4 == 1): ?>class="first"<?php endif; ?>>
            <div class="img">
                <a href='<?php echo $this->_var['goods']['url']; ?>' target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"><img data-original="<?php echo $this->_var['goods']['goods_thumb']; ?>" src="themes/shengxian/images/spacer.gif" width="200" height="200" class="loading" alt='<?php echo htmlspecialchars($this->_var['goods']['name']); ?>' /></a>
                <p class="absBg"></p>
