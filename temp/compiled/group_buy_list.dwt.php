...
?>
    <div class="qgitem_w"  data-sr="move 1rem, over 2s, enter top">
      <div class=qgitem><a href="<?php echo $this->_var['group_buy']['url']; ?>" class="pic"><img data-original="<?php echo $this->_var['group_buy']['goods_thumb']; ?>" src="themes/shengxian/images/spacer.gif" class="loading" border="0" alt="<?php echo htmlspecialchars($this->_var['group_buy']['goods_name']); ?>" /> </a>
        <div class=pic_info>
