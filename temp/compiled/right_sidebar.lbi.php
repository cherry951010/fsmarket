				...
				<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    ...
                    <li class="quick-area">
                        ...
                        <div class="sidebar-code quick-sidebar">
                        	<i class="arrow-right"></i>
		  <?php $_from = get_advlist_position_name_pc(微信二维码,0,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_91234500_1541601989');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_91234500_1541601989']):
        $this->_foreach['index_image']['iteration']++;
?>
            <img src="<?php echo $this->_var['ad_0_91234500_1541601989']['image']; ?>" width="130">
		  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>		
                        </div>
                    </li>
                    <li class="returnTop">
