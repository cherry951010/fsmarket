...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '2997件';
    }else{
...
<div id="wrapper">
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">精选优品</a> <code>&gt;</code> <a href="category.php?id=39">肉蛋速食</a> <code>&gt;</code> <a href="category.php?id=285">猪肉</a> <code>&gt;</code> 新鲜猪扒肉</div>
  <div class="detail cle"> 
     
    <div class="detail_img" id="detail_img">
  <div class="pic_view" id="li_102"> <a href="images/201707/goods_img/102_P_1499030381751.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;"> <img id="J_prodImg"  alt="新鲜猪扒肉" data-original="images/201707/goods_img/102_P_1499030381751.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_102"> </a> </div>
  ...
  <a class="next" href="javascript:void(0);"></a>
    ...
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201707/goods_img/102_P_1499030381751.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/102_P_1499030381751.jpg"> <img data-original="images/201707/thumb_img/102_thumb_P_1499030381950.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="新鲜猪扒肉"> </a></li>
            <li > <a href="images/201707/goods_img/102_P_1499046301985.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/102_P_1499046301985.jpg"> <img data-original="images/201707/thumb_img/102_thumb_P_1499046301681.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="新鲜猪扒肉"> </a></li>
            <li > <a href="images/201707/goods_img/102_P_1499046301649.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/102_P_1499046301649.jpg"> <img data-original="images/201707/thumb_img/102_thumb_P_1499046301081.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="新鲜猪扒肉"> </a></li>
            <li > <a href="images/201707/goods_img/102_P_1499046302153.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/102_P_1499046302153.jpg"> <img data-original="images/201707/thumb_img/102_thumb_P_1499046302462.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="新鲜猪扒肉"> </a></li>
            <li > <a href="images/201707/goods_img/102_P_1499046302330.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/102_P_1499046302330.jpg"> <img data-original="images/201707/thumb_img/102_thumb_P_1499046302157.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="新鲜猪扒肉"> </a></li>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>  
    ...
    <form action="javascript:addToCart(102)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <div class="item-info" id="item-info">
		...
		<script type="text/javascript" src="js/jquery.countdown-2.5.3.min.js"></script>                <h2>秒杀价：<i id="ECS_SHOPPRICE"><font>￥30.00</font></i></h2>
		<div class="market_price"><span class="timedown" id="timedown"><i class="iconfont">&#xe607;</i><font id="ps_labels_102" over="false"></font><strong id="ps_cd_102" class="font_w">请稍等, 正在载入中...</strong><font id="ps_labele_102" over="false"></font></span></div>
		<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
                    ...
                    <table width="100%">
                      <tbody>
                        <tr>
                          ...
                          <td>QQ用户</td>
                          <td><font>￥38.00</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_6">
                          <td>一星用户</td>
                          <td><font>￥36.10</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_7">
                          <td>二星用户</td>
                          <td><font>￥34.20</font></td>
                        </tr>
                                              </tbody>
                    </table>
                  </div>
	      ...
	      <span class="itemMoreInfo"><a href="javascript:;" rel="nofollow">已售出 <span class="sales">101</span></a>|<a href="javascript:;" rel="nofollow">0 人评价</a></span>
	    </div>
            <ul>
                            ...
                            <li><span>可使用<em class="red">3800</em>金币</span></li>
          ...
          <dd class="tobuy-box cle">
            <ul class="sku">
                              ...
                              <div> 
                 <span class="lbl2">部位</span>
                   
                   
                   
                  
                  <input type="hidden" name="spec_attr_type" value="6">
                  <div class="ys_xuan" id="xuan_6">
                    <div class="catt" id="catt_6"> 
                       
                      <a rev=images/201707/goods_img/102_G_1499046326895.jpg rel="zoom-id: Zoomer" href="images/201707/source_img/102_G_1499046326639.jpg" class="cattsel" onclick="show_attr_status(this,102);" name="3" id="xuan_a_3">
		      <p class="padd" style="background:url(images/201707/thumb_img/102_thumb_G_1499046326380.jpg) no-repeat transparent;" title="大腿肉">
		      		      <img src="images/201707/thumb_img/102_thumb_G_1499046326380.jpg" width="40" height="40" alt="大腿肉">
		                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_3" type="radio" name="spec_6" value="3" checked />
                      </a> 
                       
                      <a rev=images/201707/goods_img/102_G_1499046336288.jpg rel="zoom-id: Zoomer" href="images/201707/source_img/102_G_1499046336744.jpg"  onclick="show_attr_status(this,102);" name="4" id="xuan_a_4">
		      <p class="padd" style="background:url(images/201707/thumb_img/102_thumb_G_1499046336052.jpg) no-repeat transparent;" title="小腿肉">
		      		      <img src="images/201707/thumb_img/102_thumb_G_1499046336052.jpg" width="40" height="40" alt="小腿肉">
		                            <i></i>
                      </p>
                 ...
                 <span class="lbl2">规格</span>
                  ...
                  <div class="ys_xuan" id="xuan_7">
                    <div class="catt" id="catt_7"> 
                      ...
                      <a rev=images/201707/goods_img/102_G_1499046344353.jpg rel="zoom-id: Zoomer" href="images/201707/source_img/102_G_1499046344145.jpg" class="cattsel" onclick="show_attr_status(this,102);" name="5" id="xuan_a_5">
		      <p class="padd" style="background:url(images/201707/thumb_img/102_thumb_G_1499046344649.jpg) no-repeat transparent;" title="500G">
		      		      <img src="images/201707/thumb_img/102_thumb_G_1499046344649.jpg" width="40" height="40" alt="500G">
		                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_5" type="radio" name="spec_7" value="5" checked />
                      </a> 
                       
                      <a rev=images/201707/goods_img/102_G_1499046352886.jpg rel="zoom-id: Zoomer" href="images/201707/source_img/102_G_1499046352756.jpg"  onclick="show_attr_status(this,102);" name="6" id="xuan_a_6">
		      <p class="padd" style="background:url(images/201707/thumb_img/102_thumb_G_1499046352312.jpg) no-repeat transparent;" title="1000G">
		      		      <img src="images/201707/thumb_img/102_thumb_G_1499046352312.jpg" width="40" height="40" alt="1000G">
		                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_6" type="radio" name="spec_7" value="6"  />
                      </a> 
                       
                      <a rev=images/201707/goods_img/102_G_1499046359779.jpg rel="zoom-id: Zoomer" href="images/201707/source_img/102_G_1499046359470.jpg"  onclick="show_attr_status(this,102);" name="7" id="xuan_a_7">
		      <p class="padd" style="background:url(images/201707/thumb_img/102_thumb_G_1499046359484.jpg) no-repeat transparent;" title="2000G">
		      		      <img src="images/201707/thumb_img/102_thumb_G_1499046359484.jpg" width="40" height="40" alt="2000G">
		                            <i></i>
                      </p>
...
myString[5]="|4|7|";
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart_quick(102)" class="btn-buy" id="buy_btn"><font id="nowbuy">立即购买</font></a> <a href="javascript:addToCart(102)" class="btn" id="buy_btn"><font id="nowbuy">加入购物车</font></a> <a id="fav-btn" class="graybtn" href="javascript:collect(102)"><i class="iconfont">&#xe606;</i>收藏</a> 
	      <a href="javascript:;" class="btn_wap" id="phone">去手机购买
		<div style="display: none;" id="phone_tan"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img width="100" height="100" src="erweima_png.php?id=102"> </div>
                </div>
	      </a>
              <script type="text/javascript">
  ...
  <div class="taocan_bd">
   <div class="itemtaocan" id="taocan_tabs">
      <ul class="itemtaocanContent">
                <li class="itemtaocanContentFocus"><a href="javascript:void(0);">套餐一</a></li>
            </ul>
   </div>
    <div class="taocan_panels" id="taocan_panels"> 
        ...
        <form name="m_goods_0" method="post" action="" onSubmit="return false;">
          <h4></h4>
          <ul class="cle">
            <div style="float:left;"><li><a target="_blank" class="pic" href=""> <img alt="新鲜猪扒肉" data-original="images/201707/thumb_img/102_thumb_G_1499030381370.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
              <p class="name"> <a target="_blank" href="">新鲜猪扒肉</a> </p>
              <p class="price">
                <input type="checkbox" value="102" data="<font>￥30.00</font> " spare="0" stock="0" class="m_goods_body m_goods_0" item="m_goods_0">
                <font>￥30.00</font></p>
            	</li>
            </div>
            <div id="fittingBox" class="fittingitem">
              <ul> 
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=3"> <img alt="白萝卜" data-original="images/201707/thumb_img/3_thumb_G_1498959029466.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=3">白萝卜</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="3" data="<font>2.12</font>" spare="<font>1.00</font>" stock="0">
                    ￥<font>2.12</font></p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=103"> <img alt="鲜牛肉(黄牛肉)" data-original="images/201707/thumb_img/103_thumb_G_1499030526727.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=103">鲜牛肉(黄牛肉)</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="103" data="<font>20.05</font>" spare="<font>5.00</font>" stock="0">
                    ￥<font>20.05</font></p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=104"> <img alt="鸡中翅（冻）" data-original="images/201707/thumb_img/104_thumb_G_1499030656638.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=104">鸡中翅（冻）</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="104" data="<font>18.50</font>" spare="<font>3.00</font>" stock="0">
                    ￥<font>18.50</font></p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=105"> <img alt="咸鸭蛋单枚" data-original="images/201707/thumb_img/105_thumb_G_1499030857896.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=105">咸鸭蛋单枚</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="105" data="<font>2.00</font>" spare="<font>0.30</font>" stock="0">
                    ￥<font>2.00</font></p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=107"> <img alt="象太郎手提式圆纸篓（直径26CM，高28CM)顔色随机发货" data-original="images/201707/thumb_img/107_thumb_G_1499031156281.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=107">象太郎手提式圆纸篓（直径26CM，高28CM)顔色随机发货</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="107" data="<font>10.90</font>" spare="<font>2.00</font>" stock="0">
                    ￥<font>10.90</font></p>
                </li>
                ...
                <li class="plus"></li>
                <li> <a target="_blank" class="pic" href="goods.php?id=108"> <img alt="苏泊尔火红点煎锅.炫彩系列26CM-PJ26E1" data-original="images/201707/thumb_img/108_thumb_G_1499031216410.jpg" src="themes/shengxian/images/spacer.gif" class="loading"></a>
                  <p class="name"> <a target="_blank" href="goods.php?id=108">苏泊尔火红点煎锅.炫彩系列26CM-PJ26E1</a> </p>
                  <p class="price">
                    <input class="m_goods_list m_goods_0" item="m_goods_0" type="checkbox" value="108" data="<font>70.90</font>" spare="<font>9.00</font>" stock="0">
                    ￥<font>70.90</font></p>
                </li>
            ...
            <li class="price_info submit_0">
              ...
              <p class="buy"><a href="javascript:addMultiToCart('m_goods_0', '102')" class="btn">购买套餐</a></p>
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 102); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 102); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),102); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),102); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
*/
	...
	<a href="http://www.0769web.net"><img src="images/upload/Image/201606.jpg" alt="" /></a>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td width="80%"> 新鲜猪扒肉</td>
                      </tr>
                       
                       
                                            <tr>
                        <td width="64" class="th"> 产地:</td>
                        <td> 四川</td>
                      </tr>
                                            <tr>
                        <td width="64" class="th"> 来源:</td>
                        <td> 国产</td>
                      </tr>
	      ...
	      <h4>用户评价</h4>
              <div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:102;}554fcae493e564ee0dc75bdf2ebf94ca</div>
          </div>
        </div>
      </div>
...
<div class="itemBar" style="">
	<div class="wrapper">
		<div class="itemBuy"><a href="javascript:addToCart(102)" class="itemAddCart">加入购物车</a></div>
		<div class="itemMin" title="新鲜猪扒肉">
			<span><img src="images/201707/thumb_img/102_thumb_G_1499030381370.jpg"></span>
			<p>新鲜猪扒肉</p>
		</div>
