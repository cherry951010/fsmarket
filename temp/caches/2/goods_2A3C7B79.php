...
<div id="wrapper">
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">生鲜食品</a> <code>&gt;</code> <a href="category.php?id=7">蔬菜</a> <code>&gt;</code> <a href="category.php?id=48">叶菜类</a> <code>&gt;</code> 通菜（通心菜、空心菜、竹叶菜）</div>
  <div class="detail cle"> 
     
    <div class="detail_img" id="detail_img">
  <div class="pic_view" id="li_4"> <a href="images/201707/goods_img/4_P_1498959094211.jpg" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: current; zoom-distance: 10;zoom-width: 400; zoom-height: 400;"> <img id="J_prodImg"  alt="通菜（通心菜、空心菜、竹叶菜）" data-original="images/201707/goods_img/4_P_1498959094211.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_4"> </a> </div>
  ...
  <a class="next" href="javascript:void(0);"></a>
    ...
    <ul class="cle">
            ...
            <li class="current"> <a href="images/201707/goods_img/4_P_1498959094211.jpg" rel="zoom-id: Zoomer" rev="images/201707/goods_img/4_P_1498959094211.jpg"> <img data-original="images/201707/thumb_img/4_thumb_P_1498959094704.jpg" src="themes/shengxian/images/spacer.gif" class="loading" alt="通菜（通心菜、空心菜、竹叶菜）"> </a></li>
      ...
      <div class="item-info" id="item-info">
        <dl class="loaded">
          ...
          <dt class="product_name">
            <h1>通菜（通心菜、空心菜、竹叶菜）</h1>
            <p class="desc"> <span class="gray">生鲜上市</span> </p>
          </dt>
		...
		<script type="text/javascript" src="js/jquery.countdown-2.5.3.min.js"></script>                <h2>秒杀价：<i id="ECS_SHOPPRICE"><font>￥5.28</font></i></h2>
		<div class="market_price"><span class="timedown" id="timedown"><i class="iconfont">&#xe607;</i><font id="ps_labels_4" over="false"></font><strong id="ps_cd_4" class="font_w">请稍等, 正在载入中...</strong><font id="ps_labele_4" over="false"></font></span></div>
		<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
                    ...
                    <table width="100%">
                      <tbody>
                        <tr>
                          ...
                          <td>QQ用户</td>
                          <td><font>￥5.68</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_6">
                          <td>一星用户</td>
                          <td><font>￥5.40</font></td>
                        </tr>
                                                <tr id="ECS_RANKPRICE_7">
                          <td>二星用户</td>
                          <td><font>￥5.11</font></td>
                        </tr>
                                              </tbody>
                    </table>
                  </div>
	      ...
	      <span class="itemMoreInfo"><a href="javascript:;" rel="nofollow">已售出 <span class="sales">5</span></a>|<a href="javascript:;" rel="nofollow">0 人评价</a></span>
	    </div>
            <ul>
                            ...
                            <li><span>可使用<em class="red">500</em>金币</span></li>
...
var myString=new Array();
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">载入中···</font>)</cite>
              ...
              <li class="add_cart_li"> <a href="javascript:addToCart_quick(4)" class="btn-buy" id="buy_btn"><font id="nowbuy">立即购买</font></a> <a href="javascript:addToCart(4)" class="btn" id="buy_btn"><font id="nowbuy">加入购物车</font></a> <a id="fav-btn" class="graybtn" href="javascript:collect(4)"><i class="iconfont">&#xe606;</i>收藏</a> 
	      <a href="javascript:;" class="btn_wap" id="phone">去手机购买
		<div style="display: none;" id="phone_tan"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img width="100" height="100" src="erweima_png.php?id=4"> </div>
                </div>
	      </a>
              <script type="text/javascript">
...
$(function(){
	...
	$('.m_goods_body').click(function(){
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), 4); //基本件(组,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), 4); //删除基本件(组,主件)
	...
	$('.m_goods_list').click(function(){
		...
		if($(this).prop('checked')){
			ec_group_addToCart($(this).attr('item'), $(this).val(),4); //新增配件(组,配件,主件)
		}else{
			ec_group_delInCart($(this).attr('item'), $(this).val(),4); //删除基本件(组,配件,主件)
			display_Price($(this).attr('item'),$(this).attr('item').charAt($(this).attr('item').length-1));
		}
	})
	//可以购买套餐的最大数量
...
*/
        ...
        <div class="product_tabs">
	      ...
	      <h4>用户评价</h4>
              <div class="z-detail-com-box" id="ECS_COMMENT">554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:4;}554fcae493e564ee0dc75bdf2ebf94ca</div>
          </div>
        </div>
      </div>
...
<div class="itemBar" style="">
	<div class="wrapper">
		<div class="itemBuy"><a href="javascript:addToCart(4)" class="itemAddCart">加入购物车</a></div>
		<div class="itemMin" title="通菜（通心菜、空心菜、竹叶菜）">
			<span><img src="images/201707/thumb_img/4_thumb_G_1498959094209.jpg"></span>
			<p>通菜（通心菜、空心菜、竹叶菜）</p>
		</div>
