<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:56:"D:/WWW/shengxuan2018/themes/shengxian/pre_spike_list.dwt";i:1;s:61:"D:/WWW/shengxuan2018/themes/shengxian/library/page_header.lbi";i:2;s:57:"D:/WWW/shengxuan2018/themes/shengxian/library/ur_here.lbi";i:3;s:55:"D:/WWW/shengxuan2018/themes/shengxian/library/pages.lbi";i:4;s:61:"D:/WWW/shengxuan2018/themes/shengxian/library/page_footer.lbi";i:5;s:63:"D:/WWW/shengxuan2018/themes/shengxian/library/right_sidebar.lbi";}s:7:"expires";i:1541926631;s:8:"maketime";i:1541924831;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>限时秒杀_绿色生鲜商城+手机+微信商城+APP最新版</title>
<link rel="shortcut icon" href="favicon.ico" />
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
<link href="themes/shengxian/style.css" rel="stylesheet" type="text/css" />
<link href="themes/shengxian/pre_spike.css" rel="stylesheet" type="text/css" />
            ...
            <ul class="nav-items">
	            	<li>
	            		...
	            		<a href="pre_sale.php"    rel="nofollow">预售活动</a>
			            	...
			            	<li>
	            		<a href="pre_spike.php"    class="cur" rel="nofollow">限时秒杀</a>
	            	</li>
			            	<li>
...
<script type="text/javascript" src="js/jquery.countdown-2.5.3.min.js"></script><div id="wrapper">
<div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="pre_spike.php">限时秒杀</a></div>
<div class="main cle">
																		<div class="product" id="shijian_0" >
							<div class="pic" id="li_78">
								<a href="goods.php?id=78" target="_blank"> <img title="姚太太 九制半梅160g 蜜饯果干话梅子 休闲零食小吃" alt="姚太太 九制半梅160g 蜜饯果干话梅子 休闲零食小吃" width=220 height=220 data-original="images/201707/thumb_img/78_thumb_G_1498970798201.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_78"></a> 								<div class=t_icon_st></div>
															</div>
							<div class="shijian" id="shijian1_0">
								 <span id="ps_labels_78" over="false"></span><span id="ps_cd_78"></span><span id="ps_labele_78" over="false"></span>
							</div>
<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	var status = "1";
							$("#ps_labels_78").html("还剩");
							$("#ps_labele_78").html("结束");
				            					            					   	           	//if(78 == 62){
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
					   	    				...
					   	    				$("#ps_cd_78").html("");
					   	    				//$("#ps_label_78").html("销售中");
					   	    				$("#zhuangtai78").removeClass("weikaishi");
					   	    				$("#zhuangtai78").addClass("jinxinzhong");
					   	    				$("#ps_labels_78").attr("over", true);
					   	    				$("#ps_labele_78").attr("over", true);
							$("#ps_labels_78").html("还剩");
							$("#ps_labele_78").html("结束");
					   	    				status = 1;
				   	    				...
				   	    				if(ts == "End" || new Date().getTime() > endDate.getTime()){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_78").html("");
					   	    				$("#ps_labels_78").html("活动已结束");
					   	    				$("#zhuangtai78").addClass("jieshu");
					   	    				$("#ps_labele_78").html("");
					   	    				$("#ps_labels_78").attr("over", true);
					   	    				$("#ps_labele_78").attr("over", true);
					   	    			}
							...
							<div class="title">
								<a title="姚太太 九制半梅160g 蜜饯果干话梅子 休闲零食小吃" href="goods.php?id=78" target="_blank">姚太太 九制半梅160g 蜜饯果干话梅子 休闲零食小吃</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>10.88</span><span class="yp">11.88</span>
								</div>
								<span class="valid_order">16人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_78" href="javascript:collect(78);">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="goods.php?id=78" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
																								<div class="product" id="shijian_1" >
							<div class="pic" id="li_93">
								<a href="goods.php?id=93" target="_blank"> <img title=" 钙尔奇D 碳酸钙D3咀嚼片(Ⅱ) 300mg*30片" alt=" 钙尔奇D 碳酸钙D3咀嚼片(Ⅱ) 300mg*30片" width=220 height=220 data-original="images/201707/thumb_img/93_thumb_G_1498972233282.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_93"></a> 							</div>
							<div class="shijian" id="shijian1_1">
								 <span id="ps_labels_93" over="false"></span><span id="ps_cd_93"></span><span id="ps_labele_93" over="false"></span>
							</div>
<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	var status = "1";
							$("#ps_labels_93").html("还剩");
							$("#ps_labele_93").html("结束");
				            					            					   	           	//if(93 == 62){
				   	           	//	endDate = new Date(2015, 6, 29, 12, 09);
				   	           	//}
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_93").html("");
					   	    				//$("#ps_label_93").html("销售中");
					   	    				$("#zhuangtai93").removeClass("weikaishi");
					   	    				$("#zhuangtai93").addClass("jinxinzhong");
					   	    				$("#ps_labels_93").attr("over", true);
					   	    				$("#ps_labele_93").attr("over", true);
							$("#ps_labels_93").html("还剩");
							$("#ps_labele_93").html("结束");
					   	    				status = 1;
				   	    				...
				   	    				if(ts == "End" || new Date().getTime() > endDate.getTime()){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_93").html("");
					   	    				$("#ps_labels_93").html("活动已结束");
					   	    				$("#zhuangtai93").addClass("jieshu");
					   	    				$("#ps_labele_93").html("");
					   	    				$("#ps_labels_93").attr("over", true);
					   	    				$("#ps_labele_93").attr("over", true);
					   	    			}
							...
							<div class="title">
								<a title=" 钙尔奇D 碳酸钙D3咀嚼片(Ⅱ) 300mg*30片" href="goods.php?id=93" target="_blank"> 钙尔奇D 碳酸钙D3咀嚼片(Ⅱ) 300mg*30片</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>20.80</span><span class="yp">26.40</span>
								</div>
								<span class="valid_order">1人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_93" href="javascript:collect(93);">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="goods.php?id=93" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
																								<div class="product" id="shijian_2" >
							<div class="pic" id="li_75">
								<a href="goods.php?id=75" target="_blank"> <img title="新疆Q枣量贩装1000g大包" alt="新疆Q枣量贩装1000g大包" width=220 height=220 data-original="images/201707/thumb_img/75_thumb_G_1498970514133.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_75"></a> 							</div>
							<div class="shijian" id="shijian1_2">
								 <span id="ps_labels_75" over="false"></span><span id="ps_cd_75"></span><span id="ps_labele_75" over="false"></span>
							</div>
<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	var status = "1";
							$("#ps_labels_75").html("还剩");
							$("#ps_labele_75").html("结束");
				            					            					   	           	//if(75 == 62){
				   	           	//	endDate = new Date(2015, 6, 29, 12, 09);
				   	           	//}
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_75").html("");
					   	    				//$("#ps_label_75").html("销售中");
					   	    				$("#zhuangtai75").removeClass("weikaishi");
					   	    				$("#zhuangtai75").addClass("jinxinzhong");
					   	    				$("#ps_labels_75").attr("over", true);
					   	    				$("#ps_labele_75").attr("over", true);
							$("#ps_labels_75").html("还剩");
							$("#ps_labele_75").html("结束");
					   	    				status = 1;
				   	    				...
				   	    				if(ts == "End" || new Date().getTime() > endDate.getTime()){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_75").html("");
					   	    				$("#ps_labels_75").html("活动已结束");
					   	    				$("#zhuangtai75").addClass("jieshu");
					   	    				$("#ps_labele_75").html("");
					   	    				$("#ps_labels_75").attr("over", true);
					   	    				$("#ps_labele_75").attr("over", true);
					   	    			}
							...
							<div class="title">
								<a title="新疆Q枣量贩装1000g大包" href="goods.php?id=75" target="_blank">新疆Q枣量贩装1000g大包</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>41.80</span><span class="yp">43.08</span>
								</div>
								<span class="valid_order">2人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_75" href="javascript:collect(75);">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="goods.php?id=75" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
																								<div class="product" id="shijian_3" style="margin-right: 0px;">
							<div class="pic" id="li_4">
								<a href="goods.php?id=4" target="_blank"> <img title="通菜（通心菜、空心菜、竹叶菜）" alt="通菜（通心菜、空心菜、竹叶菜）" width=220 height=220 data-original="images/201707/thumb_img/4_thumb_G_1498959094209.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_4"></a> 								<div class=t_icon_st></div>
															</div>
							<div class="shijian" id="shijian1_3">
								 <span id="ps_labels_4" over="false"></span><span id="ps_cd_4"></span><span id="ps_labele_4" over="false"></span>
							</div>
<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
					   	    				...
					   	    				$("#ps_cd_4").html("");
					   	    				//$("#ps_label_4").html("销售中");
					   	    				$("#zhuangtai4").removeClass("weikaishi");
					   	    				$("#zhuangtai4").addClass("jinxinzhong");
					   	    				$("#ps_labels_4").attr("over", true);
					   	    				$("#ps_labele_4").attr("over", true);
							$("#ps_labels_4").html("还剩");
							$("#ps_labele_4").html("结束");
					   	    				status = 1;
				   	    				...
				   	    				if(ts == "End" || new Date().getTime() > endDate.getTime()){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_4").html("");
					   	    				$("#ps_labels_4").html("活动已结束");
					   	    				$("#zhuangtai4").addClass("jieshu");
					   	    				$("#ps_labele_4").html("");
					   	    				$("#ps_labels_4").attr("over", true);
					   	    				$("#ps_labele_4").attr("over", true);
					   	    			}
							...
							<div class="title">
								<a title="通菜（通心菜、空心菜、竹叶菜）" href="goods.php?id=4" target="_blank">通菜（通心菜、空心菜、竹叶菜）</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>5.28</span><span class="yp">6.81</span>
								</div>
								<span class="valid_order">5人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_4" href="javascript:collect(4);">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="goods.php?id=4" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
																								<div class="product" id="shijian_4" >
							<div class="pic" id="li_102">
								<a href="goods.php?id=102" target="_blank"> <img title="新鲜猪扒肉" alt="新鲜猪扒肉" width=220 height=220 data-original="images/201707/thumb_img/102_thumb_G_1499030381370.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_102"></a> 								<div class=t_icon_st></div>
															</div>
							<div class="shijian" id="shijian1_4">
								 <span id="ps_labels_102" over="false"></span><span id="ps_cd_102"></span><span id="ps_labele_102" over="false"></span>
							</div>
<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
			...
			Ajax.call('index.php?act=clear_cache', 'POST', 'JSON');
							...
							<div class="title">
								<a title="新鲜猪扒肉" href="goods.php?id=102" target="_blank">新鲜猪扒肉</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>30.00</span><span class="yp">45.60</span>
								</div>
								<span class="valid_order">101人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_102" href="javascript:collect(102);">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="goods.php?id=102" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
  ...
  <form name="selectPageForm" action="/pre_spike.php" method="get">
