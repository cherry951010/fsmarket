...
<div id="header" class="new_header">
 ...
 <script type="text/javascript" src="js/lizi_category.js"></script><div id="wrapper"> 
  ...
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">粮油副食</a> <code>&gt;</code> <a href="category.php?id=15">米面／杂粮</a> <code>&gt;</code> <a href="category.php?id=102">散装大米</a></div>
  <div class="main cle"> 
    <div class="maincon"> 
      ...
      <div class="search-options" id="search-options">
        <div class="bd">
          <dl>
            ...
            <dd>
              <div class="items cle"> 
                		                                <div class="link"> <a href="category.php?id=102" class="item">散装大米</a> </div>
                                                                <div class="link"> <a href="category.php?id=103" class="item">精品大米</a> </div>
                                                                <div class="link"> <a href="category.php?id=104" class="item">进口米面</a> </div>
                                                                <div class="link"> <a href="category.php?id=105" class="item">面条／粉丝</a> </div>
                                                                <div class="link"> <a href="category.php?id=106" class="item">面粉</a> </div>
                                                                <div class="link"> <a href="category.php?id=107" class="item">养生杂粮</a> </div>
                                                                <div class="link"> <a href="category.php?id=108" class="item">杂粮营养礼盒</a> </div>
  ...
  <div class="bd">
    <form method="GET" name="listform">
      <a title="销量" href="category.php?category=102&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list" class="curr" rel="nofollow"><span class="search_DESC">销量</span></a> <a title="价格" href="category.php?category=102&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"  rel="nofollow"><span class="">价格</span></a> <a title="上架时间" href="category.php?category=102&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list" rel="nofollow"><span class="">上架时间</span></a>
