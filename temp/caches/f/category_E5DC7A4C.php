...
<div id="header" class="new_header">
 ...
 <script type="text/javascript" src="js/lizi_category.js"></script><div id="wrapper"> 
  ...
  <div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">粮油副食</a> <code>&gt;</code> <a href="category.php?id=20">婴幼食品</a> <code>&gt;</code> <a href="category.php?id=141">儿童奶粉</a></div>
  <div class="main cle"> 
    <div class="maincon"> 
      ...
      <div class="search-options" id="search-options">
        <div class="bd">
          <dl>
            ...
            <dd>
              <div class="items cle"> 
                		                                <div class="link"> <a href="category.php?id=139" class="item">婴儿食品</a> </div>
                                                                <div class="link"> <a href="category.php?id=140" class="item">婴幼奶粉</a> </div>
                                                                <div class="link"> <a href="category.php?id=141" class="item">儿童奶粉</a> </div>
                                                                <div class="link"> <a href="category.php?id=142" class="item">妈咪奶粉</a> </div>
  ...
  <div class="bd">
    <form method="GET" name="listform">
      <a title="销量" href="category.php?category=141&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list" class="curr" rel="nofollow"><span class="search_DESC">销量</span></a> <a title="价格" href="category.php?category=141&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"  rel="nofollow"><span class="">价格</span></a> <a title="上架时间" href="category.php?category=141&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list" rel="nofollow"><span class="">上架时间</span></a>
