...
<title>预售活动_绿色生鲜商城+手机+微信商城+APP最新版</title>
<link rel="shortcut icon" href="favicon.ico" />
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
<link href="themes/shengxian/style.css" rel="stylesheet" type="text/css" />
<link href="themes/shengxian/pre_sale.css" rel="stylesheet" type="text/css" />
...
<div id="header" class="new_header">
            ...
            <ul class="nav-items">
	            	<li>
	            		...
	            		<a href="exchange.php"    rel="nofollow">积分兑换</a>
			            	...
			            	<li>
	            		<a href="pre_sale.php"    class="cur" rel="nofollow">预售活动</a>
	            	</li>
			            	<li>
  ...
  <script type="text/javascript" src="js/common.js"></script><script type="text/javascript" src="js/jquery.countdown-2.5.3.min.js"></script><div id="wrapper">
<div class="here cle"><a href=".">首页</a> <code>&gt;</code> <a href="pre_sale.php">预售活动</a></div>
<div class="main cle">
																		<div class="product" id="shijian_0" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_14">
								<a href="pre_sale.php?id=1" target="_blank"> <img title="烟台红富士5斤礼盒装" alt="烟台红富士5斤礼盒装" width=220 height=220 data-original="images/201707/thumb_img/14_thumb_G_1498962975550.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_14"></a> 							</div>
							<div class="shijian" id="shijian1_0">
								<i></i> <span id="ps_label_14" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_14" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="烟台红富士5斤礼盒装" href="pre_sale.php?id=1" target="_blank">烟台红富士5斤礼盒装</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥36.00</font></span><span class="yp">39.80</span>
								</div>
								<span class="valid_order">1人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_14" href="javascript:collect(14); re_collect(14)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=1" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_0").mouseenter(function(){
			            	  	var isover = $("#ps_label_14").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_14").show();
			              ...
			              $("#shijian_0").mouseleave(function(){
							...
							<div class="pic" id="li_67">
								<a href="pre_sale.php?id=2" target="_blank"> <img title="金龙鱼 葵花食用调和油5L+花生浓香食用调和油5L" alt="金龙鱼 葵花食用调和油5L+花生浓香食用调和油5L" width=220 height=220 data-original="images/201707/thumb_img/67_thumb_G_1498969691344.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_67"></a> 							</div>
							<div class="shijian" id="shijian1_1">
								<i></i> <span id="ps_label_67" style="text-align: center;" over="false">预热中</span> <span id="ps_cd_67" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="金龙鱼 葵花食用调和油5L+花生浓香食用调和油5L" href="pre_sale.php?id=2" target="_blank">金龙鱼 葵花食用调和油5L+花生浓香食用调和油5L</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥30.00</font></span><span class="yp">98.60</span>
								</div>
							...
							<div class="buy3">
								...
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=2" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              ...
			              $("#shijian_1").mouseleave(function(){
							...
							<div class="pic" id="li_15">
								<a href="pre_sale.php?id=3" target="_blank"> <img title="特级库尔勒香梨（大果）" alt="特级库尔勒香梨（大果）" width=220 height=220 data-original="images/201707/thumb_img/15_thumb_G_1498963389239.jpg" src="themes/shengxian/images/spacer.gif" class="loading pic_img_15"></a> 							</div>
							<div class="shijian" id="shijian1_2">
								<i></i> <span id="ps_label_15" style="text-align: center;" over="false">预售中</span> <span id="ps_cd_15" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="特级库尔勒香梨（大果）" href="pre_sale.php?id=3" target="_blank">特级库尔勒香梨（大果）</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span><font>￥20.00</font></span><span class="yp">15.87</span>
								</div>
								<span class="valid_order">1人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_15" href="javascript:collect(15); re_collect(15)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=3" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_2").mouseenter(function(){
			            	  	var isover = $("#ps_label_15").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_15").show();
