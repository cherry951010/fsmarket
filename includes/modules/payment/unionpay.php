...
eot;
		...
		$html .= ' <input class="btn-buy-cart" type="submit" value="'. $_LANG['pay_button']  .'"> </form>';
        return $html;
    }
    ...
    */
	 ...
	 */
	function return_url($code, $mobile='')
	{
		return $GLOBALS['ecs']->url() .$mobile. 'respond.php?code=' . $code;
	}
